      ...
      {({ open }) => (
        <>
          <div className="relative">
            <div className="shadow-sm inline-flex divide-x divide-rose-600 rounded-md">
              <div className="shadow-sm inline-flex items-center rounded-l-md border border-transparent bg-rose-500 py-2 pl-3 pr-4 text-white">
            ...
            <Transition
              ...
              leaveTo="opacity-0"
            >
              <Listbox.Options className="shadow-lg absolute right-0 z-10 mt-2 w-48 origin-top-right divide-y divide-gray-200 overflow-hidden rounded-md bg-white ring-1 ring-black ring-opacity-5 focus:outline-none">
                {publishingOptions.map(option => (
                  <Listbox.Option
                    key={option}
                    className={({ active }) =>
                      classNames(
                        active ? "bg-rose-500 text-white" : "text-gray-700",
